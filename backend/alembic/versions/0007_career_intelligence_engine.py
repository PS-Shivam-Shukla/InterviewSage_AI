...
def upgrade() -> None:
    ...
    op.create_table(
        'difficulty_history',
        sa.Column('id', sa.String(length=36), nullable=False),
        sa.Column('session_id', sa.String(length=36), sa.ForeignKey('adaptive_sessions.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_index('ix_candidate_predictions_candidate_id', 'candidate_predictions', ['candidate_id'])
    ...
    op.create_index('ix_interview_annotations_interview_id', 'interview_annotations', ['interview_id'])
    ...
    op.create_table(
        ...
        sa.Column('id', sa.String(length=36), nullable=False),
        sa.Column('source_id', sa.String(length=36), sa.ForeignKey('knowledge_graph_nodes.id', ondelete='CASCADE'), nullable=False),
        sa.Column('target_id', sa.String(length=36), sa.ForeignKey('knowledge_graph_nodes.id', ondelete='CASCADE'), nullable=False),
