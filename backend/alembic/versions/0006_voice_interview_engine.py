...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('active_worker_id', sa.String(length=50), nullable=False, server_default='worker-01'),
    ...
    op.create_table(
        'conversation_turns',
        sa.Column('id', sa.String(length=36), nullable=False),
        sa.Column('session_id', sa.String(length=36), sa.ForeignKey('live_sessions.id', ondelete='CASCADE'), nullable=False),
        ...
        sa.Column('agent_name', sa.String(length=100), nullable=False, server_default='TechnicalInterviewAgent'),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table(
        ...
        sa.Column('total_silence_duration_seconds', sa.Float(), nullable=False, server_default='0.0'),
