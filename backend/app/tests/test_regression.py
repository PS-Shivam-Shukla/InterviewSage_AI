...
def test_regression_tester_detects_accuracy_drop():
    ...
    baseline = {"run_name": "v1", "pass_rate": 85.0, "avg_hallucination": 5.0, "avg_latency_ms": 1000.0, "avg_cost_usd": 0.001}
    target = {"run_name": "v2", "pass_rate": 70.0, "avg_hallucination": 5.0, "avg_latency_ms": 1000.0, "avg_cost_usd": 0.001}
...
def test_regression_tester_detects_hallucination_spike():
    ...
    baseline = {"run_name": "v1", "pass_rate": 85.0, "avg_hallucination": 5.0, "avg_latency_ms": 1000.0, "avg_cost_usd": 0.001}
    target = {"run_name": "v2", "pass_rate": 85.0, "avg_hallucination": 20.0, "avg_latency_ms": 1000.0, "avg_cost_usd": 0.001}
