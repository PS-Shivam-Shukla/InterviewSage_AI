...
TASK_MODEL_MAPPING: dict[str, dict[str, ModelSpec]] = {
    "FAST_EXTRACTION": {
        ...
        "nvidia": ModelSpec(
            "nvidia", "llama-3.1-70b-instruct", 128000, 900, "ollama", "qwen2.5:3b"
        ),
    },
    "PERSONALIZATION": {
    ...
    "DEEP_EVALUATION": {
        "ollama": ModelSpec(
            "ollama", "deepseek-r1-distill-qwen:8b", 8192, 3000, "ollama", "qwen2.5:7b"
        ),
        "openai": ModelSpec(
            "openai", "gpt-4o", 128000, 2000, "ollama", "deepseek-r1-distill-qwen:8b"
        ),
        "claude": ModelSpec(
            "claude", "claude-3-5-sonnet", 200000, 2200, "ollama", "deepseek-r1-distill-qwen:8b"
        ),
        "gemini": ModelSpec(
            "gemini", "gemini-1.5-pro", 1000000, 1800, "ollama", "deepseek-r1-distill-qwen:8b"
        ),
        "nvidia": ModelSpec(
            "nvidia", "nemotron-4-340b", 128000, 2500, "ollama", "deepseek-r1-distill-qwen:8b"
        ),
    },
    "REPORT_SYNTHESIS": {
