...
class AudioStreamingService:
    ...
    def process_voice_turn_orchestrated(
        ...
        return {
            ...
            "live_scores": {
                "technical_score": metrics.technical_score if metrics else 88.0,
                "communication_score": metrics.communication_score if metrics else 90.0,
                "confidence_estimate": metrics.confidence_estimate if metrics else 92.0,
                "speaking_speed_wpm": metrics.avg_speaking_speed_wpm if metrics else 140.0,
            },
            "audio_response_bytes": audio_out,
            "stt_latency_ms": stt_latency_ms,
            "tts_latency_ms": tts_latency_ms,
